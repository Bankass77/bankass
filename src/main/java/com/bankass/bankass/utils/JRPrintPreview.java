...
public class JRPrintPreview extends Stage {
	...
	public JRPrintPreview(JasperReportsContext jasperReportsContext, JasperPrint jasperPrint,
		...
		double width = vBoxPage.getBoundsInParent().getWidth() + 2 * SPACING + 13; // vBoxPage width + 2 * SPACING +
	...
	private void initComponents() {
		...
		btnPrint.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/print.GIF")))); // NOI18N
		...
		btnFirst.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/first.GIF")))); // NOI18N
		...
		btnPrevious.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/previous.GIF")))); // NOI18N
		...
		btnNext.setGraphic(
				new ImageView(new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/next.GIF")))); // NOI18N
		...
		btnLast.setGraphic(
				new ImageView(new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/last.GIF")))); // NOI18N
		...
		btnSave.setGraphic(
				new ImageView(new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/save.GIF")))); // NOI18N
		btnSave.setTooltip(new Tooltip("Save Image"));
		btnSave.setPrefSize(23, 23);
		btnSave.setOnAction(e -> onSave());
		btnSave.setFocusTraversable(false);

		btnActualSize.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/actualsize.GIF")))); // NOI18N
		...
		btnFitPage.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/fitpage.GIF")))); // NOI18N
		...
		btnFitWidth.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/fitwidth.GIF")))); // NOI18N
		...
		toolBar.getItems().addAll(btnSave, btnActualSize, btnFitPage, btnFitWidth, new Separator(), btnZoomIn,
				btnZoomOut, cmbZoom, new Separator(), btnFirst, btnPrevious, txtGoTo, btnNext, btnLast, new Separator(),
				btnPrint);

		btnZoomIn.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/zoomin.GIF")))); // NOI18N
		...
		btnZoomOut.setGraphic(new ImageView(
				new Image(getClass().getResourceAsStream("/net/sf/jasperreports/view/images/zoomout.GIF")))); // NOI18N
	...
	private void onSetFitToWidthPressed() {
		cmbZoom.getSelectionModel().clearSelection(); // Has to be before setRealZoomRatio() call because
														// clearSelection() will clear cmbZoom text box
		setRealZoomRatio((float) (scrollPane.getViewportBounds().getWidth() - 2 * SPACING - 2)
	...
	private void onFitPagePressed() {
		...
		float heightRatio = ((float) scrollPane.getViewportBounds().getHeight() - 2 * SPACING)
				/ pageFormat.getPageHeight();
		float widthRatio = ((float) scrollPane.getViewportBounds().getWidth() - 2 * SPACING)
