...
public class WindowsUtils {
	...
	public static final String BASE_APPLICATION_CSS_PATH = StockManagement.class.getResource("/css/applications.css").toExternalForm();
	...
	public static FXMLLoader loadFxml(String url) {
		 ...
		 try (InputStream fxmlStream = WindowsUtils.class.getResourceAsStream(url)) {
			 ...
			 loader.setControllerFactory( clazz -> { return StockManagement.applicationContext.getBean(clazz);});
