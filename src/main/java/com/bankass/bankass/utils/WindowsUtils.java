...
public class WindowsUtils {
	...
	public static <T> Stage openNewWindow(String fxmlPath, String title, String iconPath, HashMap<String, T> parameters,
			Modality windowModality) throws Exception {
	...
	public static <T> Stage openNewWindow(Stage stage, String fxmlPath, String title, String iconPath,
			HashMap<String, T> parameters) throws Exception {
	...
	public static FXMLLoader loadFxml(String url) {
		...
		try (InputStream fxmlStream = WindowsUtils.class.getResourceAsStream(url)) {
			...
			loader.setControllerFactory(clazz -> {
				return StockManagement.applicationContext.getBean(clazz);
			});
			loader.setResources(StockManagement.i18n.getBundle());
