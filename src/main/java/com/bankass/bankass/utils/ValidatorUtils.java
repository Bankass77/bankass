...
import com.bankass.bankass.validators.DecimalValidator;
import com.bankass.bankass.validators.DuplicateUserValidator;
import com.bankass.bankass.validators.EmailValidator;
import com.bankass.bankass.validators.MaxLengthValidator;
import com.bankass.bankass.validators.MoneyValidator;
import com.bankass.bankass.validators.NumberValidator;
import com.bankass.bankass.validators.PasswordAndConfirmPasswordValidator;
...
public class ValidatorUtils {
	...
	public static DuplicateUserValidator addDuplicateUserValidator(JFXTextField textField, String message,
			UserService user) {
	...
	public static PasswordAndConfirmPasswordValidator addPasswordAndConfirmPasswordValidator(
			JFXPasswordField passwordTextField, JFXPasswordField confirmPasswordTextField, String message) {
		PasswordAndConfirmPasswordValidator passwordAndConfirmPasswordValidator = new PasswordAndConfirmPasswordValidator(
	...
	private static <T> ValidationFacade addValidator(ValidatorBase validatorBase, JFXComboBox<T> comboBox,
			String message) {
