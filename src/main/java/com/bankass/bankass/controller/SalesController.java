...
import com.bankass.bankass.controller.SaleTableController.TypeSaleTable;
...
public class SalesController extends BaseController {
	...
	public void onNewSale() throws Exception {
		WindowsUtils.openNewWindow(SalesNewController.PATH_FXML, getWindowTitle(SalesNewController.NEW_SALE_TITLE_KEY),
				SalesNewController.PATH_ICON, null, Modality.APPLICATION_MODAL);
	}
