...
public class EmployeeNewController extends BaseController {
	...
	private void updateTextFields() {
		...
		if (employee.getUser() != null) {
			WindowsUtils.setSelectedComboBoxItem(roleComboBox, employee.getUser().getRoles().stream().findFirst().get());
	...
	public void onSave() {
		...
		Set<Phone> s = new HashSet<>(Arrays.asList(EntityFactory.createPhone(WindowsUtils.getLongFromTextField(cellTextField)),
		...
		roleService.findByRole(roleSelected.getRole(), en -> {
			User user = EntityFactory.createUser(WindowsUtils.getTextFromTextField(emailTextField), 
					 ...
					 (Set<Role>) en.getSource().getValue());
