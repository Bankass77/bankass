package com.bankass.bankass.validators;
...
public class PasswordAndConfirmPasswordValidator extends ValidatorBase {
	...
	public PasswordAndConfirmPasswordValidator(JFXPasswordField passwordTextField,
			JFXPasswordField confirmPasswordTextField) {
