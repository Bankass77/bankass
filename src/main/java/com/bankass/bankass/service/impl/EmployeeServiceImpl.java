...
public class EmployeeServiceImpl extends BaseCrudService<Employee, JpaRepository<Employee, Long>>
	...
	@Override
	public javafx.concurrent.Service<Long> getTotalEmployees(EventHandler<WorkerStateEvent> onSucess,
